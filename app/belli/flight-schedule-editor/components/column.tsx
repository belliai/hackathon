...
export const columns = (
  ...
  },
  {
    accessorKey: "to_date",
    header: () => (
      <TableHeaderWithTooltip header="Arrival" tooltipId="flight-master-sta" />
    ),
    cell: ({ row }) => {
...

  {
    ...
    header: () => (
      <TableHeaderWithTooltip header="From" tooltipId="flight-master-source" />
    ),
    cell: ({ row }) => {
