    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 rounded-lg border-[1px] border-zinc-700 p-5">
          <div className="text-white text-base font-semibold">New</div>
          ...
          <div className="flex gap-4 w-full">
            ...
            <div className="flex flex-col gap-2 w-1/5">
              ...
              <Input className="border-zinc-700" placeholder="AWB Destination" />
            </div>
          ...
          <div className="flex gap-4 w-full">
            ...
            <div className="flex flex-col gap-2 w-1/5">
              ...
              <Input className="border-zinc-700" placeholder="Transit Duration" />
            </div>
          ...
          <div className="text-white text-base font-semibold">World Wide Tracking</div>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      {WWT_STATUS_LIST.map((wwtList) => (
                        <SelectItem key ={wwtList.id} value={wwtList.label}>{wwtList.label}</SelectItem>
                      ))}
                    </SelectGroup>
                  </SelectContent>
                </Select>
          ...
          <div className="flex gap-2 mt-5">
            <Button className="bg-button-secondary hover:bg-button-secondary/80 text-white w-fit">
              ePouch
            </Button>
