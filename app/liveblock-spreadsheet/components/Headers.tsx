...
function HeaderDragOverlay({
  ...
  return (
    <div
      className={cn(className, styles.overlay, isColumn ? "column" : "row")}
      style={{
...
export function Header({
  ...
  useEffect(() => {
    const changeGlobalCursor = isDragging ? setGlobalCursor : removeGlobalCursor
      ...
      >
        ...
        >
          <div className={styles.header}>
            <button
              className={cn(styles.header_control, styles.header_handler)}
            ...
            >
              <button className={cn(styles.header_control, styles.header_menu)}>
                <EllipsisIcon />
              </button>
            </DropdownMenu>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        <div
          aria-hidden
          className={cn(className, styles.headers, type)}
          {...props}
        >
