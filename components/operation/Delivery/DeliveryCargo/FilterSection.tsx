      ...
      <div className="flex flex-col gap-4 rounded-lg border-[1px] border-zinc-700 p-5">
        ...
        <div className="flex w-full gap-4">
          <div className="w-2/12">
            <Input className="border-zinc-700" placeholder="DO#" />
          </div>
          ...
          <div className="w-2/12">
            <Input className="border-zinc-700" placeholder="ULD No" />
          </div>
          ...
          <div className="w-2/12">
            <Input className="border-zinc-700" placeholder="Flight Code" />
          </div>
        ...
        <div className="flex w-full gap-4">
          ...
          <div className="w-2/12">
            <Input className="border-zinc-700" placeholder="Consignee" />
          </div>
