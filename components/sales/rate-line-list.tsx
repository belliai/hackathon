  ...
  return (
    <div>
      ...
      <div>
        ...
        <Checkbox id="tact rate" />
      </div>
      <div>
        <label>ULD Rate</label>
        <Checkbox id="uld rate" />
      </div>
      <div>
        <label>Heavily Applicable</label>
        <Checkbox id="heavily applicable" />
      </div>
      <div>
        <label>All in Rate</label>
        <Checkbox id="all inrate" />
      </div>
      <div>
        <label>Is Prime</label>
        <Checkbox id="is prime" />
      </div>
      <div>
        <Button>List</Button>
        <Button>Clear</Button>
