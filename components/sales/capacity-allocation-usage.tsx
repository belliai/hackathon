                ...
                <div>
                    ...
                    <Popover>
                        ...
                        <PopoverContent className="w-auto p-0">
                            <Calendar mode="single" selected={fromDate} onSelect={(day) => day && setFromDate(day)} initialFocus />
                        </PopoverContent>
                    </Popover>
                </div>
                <div>
                    ...
                    <Popover>
                        ...
                        <PopoverContent className="w-auto p-0">
                            <Calendar mode="single" selected={toDate} onSelect={(day) => day && setToDate(day)} initialFocus />
                        </PopoverContent>
                    </Popover>
                </div>
