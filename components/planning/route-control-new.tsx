  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="row-gap-2 col-span-1 grid grid-cols-2 gap-2">
          <div>
            <Label htmlFor="refNo">Ref. No.</Label>
            <Input id="refNo" />
          </div>
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0">
                <Calendar
                  mode="single"
                  selected={flightDate}
                  onSelect={handleFlightDateChange}
                />
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className="border-l pl-4">
          ...
          <div className="col-span-2 grid grid-cols-2 gap-2">
            {[
              ...
              "SHC",
              "ULD Categories",
              "Days of Week (Booking Date)",
              "Days of Week (Flight Date)",
              "Payment Type",
              "Equipment Type",
              "Flight Type",
              "Part Shipment Block",
          ...
          <div>
            <Label htmlFor="Days of Week (Booking Date)">
              Days of Week (Booking Date)
            </Label>
          ...
          <div>
            <Label htmlFor="Days of Week (Flight Date)">
              Days of Week (Flight Date)
            </Label>
            <div className="flex flex-wrap gap-2">
              <div className="flex items-center space-x-2">
