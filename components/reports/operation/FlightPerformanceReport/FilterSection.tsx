    ...
    <div className="flex flex-col mt-10 gap-4">
      ...
      <div className="flex flex-col gap-4 rounded-lg border-[1px] border-zinc-700 p-5">
        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/6">
            <Input className="border-zinc-500" placeholder="From Station" rightIcon={<MagnifyingGlassIcon className="h-4 w-4 text-zinc-400" />} />
          </div>

          <div className="w-1/6">
            <Input className="border-zinc-500" placeholder="To Station" rightIcon={<MagnifyingGlassIcon className="h-4 w-4 text-zinc-400" />} />
          </div>
              ...
              <SelectContent>
                <SelectGroup>
                  {REPORT_TYPE_LIST.map((reportType) => (
                    <SelectItem key ={reportType.id} value={reportType.label}>{reportType.label}</SelectItem>
                  ))}
                </SelectGroup>
              </SelectContent>
            </Select>
              ...
              <SelectContent>
                <SelectGroup>
                  {PARTNER_CODE_LIST.map((partnerCode) => (
                    <SelectItem key ={partnerCode.id} value={partnerCode.label}>{partnerCode.label}</SelectItem>
                  ))}
                </SelectGroup>
              </SelectContent>
            </Select>
