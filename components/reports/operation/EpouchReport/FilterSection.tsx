  ...
  return (
    <div className="flex flex-col mt-10 gap-4">
      <div className="flex justify-between">
        <h1 className="text-xl font-semibold">E-Pouch Report</h1>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/6">
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  {AIRPORT_TYPE_LIST.map((airpotList) => (
                    <SelectItem key ={airpotList.id} value={airpotList.label}>{airpotList.label}</SelectItem>
                  ))}
                </SelectGroup>
              </SelectContent>
            </Select>
        ...
        <div className="flex gap-4">
          <div className="w-1/6">
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  {DOCUMENT_TYPE_LIST.map((documentList) => (
                    <SelectItem key ={documentList.id} value={documentList.label}>{documentList.label}</SelectItem>
                  ))}
                </SelectGroup>
              </SelectContent>
            </Select>
          ...
          <div className="w-1/6">
            <Input className="border-zinc-500" placeholder="AWB No" rightIcon={<MagnifyingGlassIcon className="h-4 w-4 text-zinc-400" />} />
          </div>
