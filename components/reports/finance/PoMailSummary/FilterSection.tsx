  ...
  return (
    <div className="flex flex-col mt-10 gap-4">
      <div className="flex justify-between">
        <h1 className="text-xl font-semibold">PO Mail Summary</h1>
      ...
      <div className="flex flex-col gap-4 rounded-lg border-[1px] border-zinc-700 p-5">
        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/6">
            <Input className="border-zinc-500" placeholder="PO Mail Agent Code" rightIcon={<MagnifyingGlassIcon className="h-4 w-4 text-zinc-400" />} />
          </div>
