    ...
    <>
      <div>
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-zinc-800 bg-zinc-900 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            <button
              type="button"
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <Image
                      className="h-8 w-8 rounded-full bg-zinc-950"
                    ...
                    <span className="hidden lg:flex lg:items-center">
                      <span
                        className="ml-4 text-sm font-semibold leading-6 text-zinc-100"
                        aria-hidden="true"
                      >
                        Welcome, Jeff
                      </span>
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-zinc-900 py-2 shadow-lg ring-1 ring-zinc-900/5 focus:outline-none">
