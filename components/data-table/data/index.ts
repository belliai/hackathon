import { add, addDays, endOfMonth, endOfWeek, endOfYear, startOfDay, startOfMonth, startOfWeek, startOfYear, sub, subDays } from "date-fns"
import { OptionWithUrl, Option, Direction, Period } from "../types"
...
export const dummyUserOptions: OptionWithUrl[] = [
  ...
  export function mapValueToDate(value: string, customDate?: Date): Date | undefined {
