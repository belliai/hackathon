    ...
    <Table>
      ...
      <TableFooter>
        <TableRow>
          ...
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.ld7Onhand, 0)}
          </TableCell>
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.expectedLd7, 0)}
          </TableCell>
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.ld3Onhand, 0)}
          </TableCell>
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.expectedLd3, 0)}
          </TableCell>
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.ld9Onhand, 0)}
          </TableCell>
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.expectedLd9, 0)}
          </TableCell>
          <TableCell>
            {uldStockData.reduce((sum, item) => sum + item.total, 0)}
          </TableCell>
        </TableRow>
      </TableFooter>
    </Table>
