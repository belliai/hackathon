    ...
    return (
      <div className="text-center">
        ...
        <div className="flex gap-1">
          ...
          <div className="w-full md:w-1/3">{renderTable("Pending at Origin Airport", pendingOriginAirport)}</div>
          <div className="w-full md:w-1/3">{renderTable("Pending at Destination WH", pendingAtDestination)}</div>
        </div>
      </div>
    );
  }